...
class ConceptWindow(ctk.CTkToplevel):
    ...
    def __general_tab(self, master, concept: ConceptConfig):
        ...
        components.path_entry(frame, 3, 1, self.ui_state, "path", path_type="directory")
        ...
        prompt_path_entry = components.path_entry(frame, 4, 2, self.text_ui_state, "prompt_path", path_type="file")
